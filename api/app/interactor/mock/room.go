...
type MockRoomUsecase struct {
	...
	ShowFunc   func(ctx context.Context, id model.RoomID, userID model.UserID) (*model.RoomUser, error)
}
...
func (m *MockRoomUsecase) Show(ctx context.Context, id model.RoomID, userID model.UserID) (*model.RoomUser, error) {
	return m.ShowFunc(ctx, id, userID)
}

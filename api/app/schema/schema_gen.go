...
func InsertPost(ctx context.Context, execer execer, values ...*Post) error {
	const q = "INSERT INTO `post` (`id`, `user_id`, `title`, `created_at`, `updated_at`, `img`) VALUES (?, ?, ?, ?, ?, ?)" +
		", (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?), (?, ?, ?, ?, ?, ?)"
	const fieldCount = 6
	const maxStructCount = 32
	var args []any
	if len(values) >= maxStructCount {
		...
		err := func() error {
			...
			for len(values) >= maxStructCount {
				...
				args = args[:0]
				for _, v := range vals {
					args = append(args, v.ID, v.UserID, v.Title, v.CreatedAt, v.UpdatedAt, v.Img)
				}
				if _, err := stmt.ExecContext(ctx, args...); err != nil {
					return err
				}
	...
	if _, err := execer.ExecContext(ctx, q[:len(values)*20+86], args...); err != nil {
		return err
	}
	return nil
}

...
type MockGoogleService struct {
	...
	GetUserInfoFunc func(ctx context.Context, code string) (*model.User, error)
}
...
func (m *MockGoogleService) GetUserInfo(ctx context.Context, code string) (*model.User, error) {

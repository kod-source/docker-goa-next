...

{
   ...
   "title": "やっほー"
	...
	tmp5 := new(GetCurrentUserUsersCommand)
	sub = &cobra.Command{
...

{
   ...
   "password": "test1234"
	...
	tmp9 := new(ShowCommentCommentsCommand)
	sub = &cobra.Command{
